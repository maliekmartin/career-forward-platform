...
const resources: Resource[] = [
  // Job Centers
  {
    ...
    description: "One-stop career center offering job search assistance, training programs, and employment services for local residents.",
    address: "130 S Arthur St, Spokane, WA 99202",
    phone: "(509) 555-3000",
    website: "https://example.com/career-center",
    category: "job-centers",
    industries: ["all"],
    tags: ["Job Search Assistance", "Resume Help", "Career Counseling", "Skills Training", "Training Programs"],
    icon: "building",
    featured: true,
  },
  {
